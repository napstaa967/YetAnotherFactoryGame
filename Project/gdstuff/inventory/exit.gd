...
func _pressed():
	get_parent().get_parent().get_parent().get_parent().inventory_open = false
	get_parent().get_parent().get_parent().get_parent().remove_child(get_parent().get_parent().get_parent())
