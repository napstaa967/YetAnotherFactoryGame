...
func _enter_tree():
	self.editor_description = "A container that lays out it's children on a horizontal row according to their minimum sizes. When it can't fit another, it starts a new row."
